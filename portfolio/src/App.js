...
function App() {
  ...
  return (
    <div className="app-container" ref={comp}>
      <div id="intro-slider" className="Intro">
        <div className="role" id="title-1">
          Goal-Oriented
        </div>
        <div className="role" id="title-2">
          Problem-Solver
        </div>
        <div className="role" id="title-3">
          Determined
        </div>
        <div className="role" id="title-4">
          CS Student at the University of Houston
        </div>
        <div className="role" id="title-5">
          Jackson Nace
        </div>
      </div>
      <div className="App" id="app">
