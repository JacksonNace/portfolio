  ...
  return (
    <div className="projects-container">
      {projects.map((project, index) => (
        <div
          key={project.id}
          className={`project-card ${index % 2 === 0 ? "left-image" : "right-image"}`} // Alternating classes
        >
          <div className="project-image-container"> {/* Container for the image */}
            <img src={project.imageUrl} alt={project.title} className="project-image" />
          </div>

          <div className="project-content"> {/* Container for the content */}
